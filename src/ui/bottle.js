...
export function bindBottle({ getClickPower, onClick, formatValue }) {
    console.log('🔧 bindBottle called - initializing bottle click handler');
    
    // Sprawdź czy element bottle istnieje
    if (!elements.bottle) {
        console.error('❌ Bottle element not found!');
        return;
    }
    
    console.log('✅ Bottle element found:', elements.bottle);
    ...
    function handleClick(event) {
        ...
        console.log('🖱️ Click detected on bottle, power:', getClickPower());
        ...
        console.log('🎨 Spawning click effect:', { x: clickX, y: clickY, value: formatted, speed });
    ...
    console.log('✅ Bottle binding completed successfully! Click effects should work now.');
}